...
export const en = {
  ...
  investment_number_text:
    'An investment number needs to be added before you can review a goal.',
  ...
  own_use_notes_description:
    'These notes will not be visible on any client facing documents',
  ...
  deposit_starting_balance_required:
    'Please enter a deposit / starting balance',
  deposit_starting_balance_number:
    'Deposit / starting balance has to be a number',
  deposit_starting_balance_minimum_zar:
    'Deposit / starting balance has to be more than ZAR 5 000.00',
  deposit_starting_balance_minimum_usd:
    'Deposit / starting balance has to be more than USD 5 000.00',
  deposit_starting_balance_minimum_gbp:
    'Deposit / starting balance has to be more than GBP 5 000.00',
  deposit_starting_balance_cannot_exceed_capital_amount:
    'Your deposit cannot exceed the capital amount',
  deposit_cannot_exceed_capital_amount:
    'Your deposit / starting balance cannot exceed the capital amount',
  additional_payment_cannot_exceed_capital_amount:
    'Your additional payment cannot exceed the capital amount',
  deposit_cannot_exceed_income_required_x_duration:
    'Your deposit / starting balance cannot exceed the Income required x Income duration',
  additional_payment_cannot_exceed_income_required_x_duration:
    'Your additional payment cannot exceed the Income required x Income duration',
  ...
  additional_payment_minimum_zar:
    'Additional payment has to be more than ZAR 5 000.00',
  additional_payment_minimum_usd:
    'Additional payment has to be more than USD 1 000.00',
  additional_payment_minimum_gbp:
    'Additional payment has to be more than GBP 1 000.00',
  ...
  calculate_fund_recommendation_subtext:
    'Input the client’s personal risk profile (PRP) as determined by the financial needs analysis (FNA)',
  ...
  recurring_premium_minimum_zar:
    "Recurring premium can't be less than ZAR 500.00",
  recurring_premium_minimum_usd:
    "Recurring premium can't be less than USD 500.00",
  recurring_premium_minimum_gbp:
    "Recurring premium can't be less than GBP 500.00",
  ...
  eac_tooltip_text:
    'Effective Annual Cost is a standardised measure used to compare the effect of charges over the term of an investment plan',
  disclaimer:
    'The illustration is based on past performance and based on data believed to be accurate and reliable. However, this does not suggest or imply and should not be construed, in any manner, a guarantee of future performance. Past performance does not guarantee future results.',
  income_amount_number_error: 'Income amount has to be a number.',
  expense_amount_number_error: 'Expense amount has to be a number.',
  income_required_per_annum_number:
    'Income required per annum has to be a number.',
  ...
  sign_out_message2:
    'To continue using the advisor portal, please sign back in.',
  ...
  finalise_goal_content_paragraph1:
    'Are you sure you want to finalise this goal?',
  finalise_goal_content_paragraph2:
    'When a goal is finalised, you will be able to download the relevant goal documents but you won’t be able to edit or delete this goal.',
  finalise_review_content_paragraph1:
    'Are you sure you want to finalise this review?',
  finalise_review_content_paragraph2:
    'When a review is finalised, you will be able to download the relevant goal documents but you won’t be able to edit or delete this review.',
  finalise_review: 'Finalise review',
  continue_later: 'Continue later',
  download_proposal: 'Download proposal',
  confirm_and_complete:
    'Confirm and complete the details below to populate the application form for this goal.',
  increase_risk_tolerance_title: 'Increase Risk Tolerance',
  increase_risk_tolerance:
    'The selected fund based on risk tolerance is higher than the initial risk and fund recommendation',
  amend: 'Amend',
  accept: 'Accept',
  ...
  current_investment_value_number_error:
    'Current investment value has to be a number',
  ...
  client_not_found:
    'This client cannot be found. Please ensure that the ID number / Passport number / BPID is correct.',
  ...
  offshore: 'Offshore',
  onshore: 'Onshore',
  initial_advice_fee_text:
    'Fixed fee option is applicable to the recurring monthly contributions on GoalStandard Funds only.',
  bpid: 'BPID',
  changed_recommended_fund_title: 'Changed recommended fund',
  generic_fund_popup_description:
    'The selected fund is a deviation from the original recommended fund.'
};
// tslint:enable
